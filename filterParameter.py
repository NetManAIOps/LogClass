...
def getMsgFromNewSyslog(log):
    ...
    '''
    Returns log message having filtered its variables and tokens with non-letter characters.
...
if __name__ == '__main__':
    ...
    parser.add_argument('-input', help = 'input file path', type = str, default = './data/rawlog.txt')
    parser.add_argument('-output', help = 'output file path', type = str, default = './data/logs_without_paras.txt')
